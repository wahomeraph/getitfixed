...
private ImageView ceo, hr, sale, manage,seck;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ceo=(ImageView)view.findViewById(R.id.ceoo);
        ...
        hr=(ImageView)view.findViewById(R.id.hrm);
        ...
        manage=(ImageView)view.findViewById(R.id.sm);
        ...
        seck=(ImageView)view.findViewById(R.id.secret);
        seck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getContext(),message.class);
                startActivity(i); }
